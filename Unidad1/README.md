...
- [How to learn distributed system?](#how-to-learn-distributed-system)
- [What could go wrong?](#what-could-go-wrong)
- [The many types of fail](#the-many-types-of-fail)
- [Byzantine fault tolerance](#byzantine-fault-tolerance)
- [SLIs SLOs and SLAs](#slis-slos-and-slas)
- [Class Project](#lass-project)
- [Paxos Simplified](#paxos-simplified)
- [Introduction to Blockshain Consensus](#introduction-to-blockshain-consensus)
- [What is a Blockshain](#what-is-a-blockshain)
- [13 Bitcoin Blockshain Consensus](#bitcoin-blockshain-consensus)
...
## Introduction to Blockshain Consensus
